 ...
 */
export type EnrollmentGrantState = 'used' | 'superseded' | 'expired' | 'unknown';
 ...
 */
export type EnrollmentGrantRejection = {
 ...
 */
export type CredentialProvenance = 'enrollment' | 'credential';
...
export type RevokeCredentialResult = 'revoked' | 'not_found' | 'last_credential';
